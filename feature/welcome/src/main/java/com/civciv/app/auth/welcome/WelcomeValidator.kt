...
@Singleton
internal class WelcomeValidator @Inject constructor(
    private val validateDomainUseCase: ValidateDomainUseCase,
) : WelcomeContract.Validator {
    override fun validateDomain(domain: String): ValidationResult {
        return validateDomainUseCase.invoke(domain)
    }
}
